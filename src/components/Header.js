...
const Header = () => {
  ...
  return (
    <header className="bg-sky-100 shadow-md fixed w-full top-0 z-50">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button onClick={() => scrollToSection('updates')} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-amber-400 transition-colors">News</button>
